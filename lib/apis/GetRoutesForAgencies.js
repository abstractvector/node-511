...
(function() {
  var AbstractService, GetRoutesForAgencies,
  ...
  GetRoutesForAgencies = (function(_super) {
    __extends(GetRoutesForAgencies, _super);

    function GetRoutesForAgencies() {
      this.invoke = __bind(this.invoke, this);
      return GetRoutesForAgencies.__super__.constructor.apply(this, arguments);
    }

    GetRoutesForAgencies.prototype.invoke = function(parameters, callback) {
      if (parameters == null) {
        parameters = {};
      }
      if (callback == null) {
      ...
      if (parameters.agencyNames == null) {
        parameters.agencyNames = [];
      }
      parameters.agencyNames = parameters.agencyNames.join('|');
      return GetRoutesForAgencies.__super__.invoke.call(this, parameters, callback);
    };

    GetRoutesForAgencies.prototype._parse = function(obj) {
      var agencies, agency, name, routeDirections, routes, _A, _R, _RD, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref18, _ref19, _ref2, _ref20, _ref21, _ref22, _ref23, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
      agencies = {};
